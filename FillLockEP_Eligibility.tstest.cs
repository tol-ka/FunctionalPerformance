...
namespace PerformanceTesting
{
    ...
    public class FillLockEPEligibility : BaseWebAiiTest
    {
        ...
        {
                        Utility.eventName = @"EP Eligibility Meeting";
        }
        ...
        {
                        Utility.eventGroupName = @"EP Eligibility Meeting and EP Initial Meeting";
        }
        
        [CodedStep(@"Set event Type")]
        public void setEventType()
        {
            Utility.eventType = @"Eligibility";
        }
    }
}
