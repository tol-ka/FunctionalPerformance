...
namespace PerformanceTesting
{
    ...
    public class FillLockIEPReconvenient : BaseWebAiiTest
    {
...
System.Runtime.InteropServices.Marshal.ReleaseComObject(excelApp);
        ...
        {
            Utility.eventName = @"IEP Reconvened Meeting";
        }
        
         [CodedStep(@"Set event Group Name")]
        public void setEventGroupName()
        {
            Utility.eventGroupName = @"IEP Reconvened Meeting";
        }
         [CodedStep(@"Set event Type")]
        public void setEventType()
        {
            Utility.eventType = @"Reconvened";
        }
